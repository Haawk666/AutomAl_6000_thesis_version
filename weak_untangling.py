    ...
    for vertex in graph_obj.vertices:
        for partner in vertex.partners():
            ...
            if not graph_obj.vertices[partner].partner_query(vertex.i) and\
                ...
                print('Investigating {} {}'.format(vertex.i, partner))
    ...
    for vertex in graph_obj.vertices:
        for partner in vertex.partners():
            ...
            if not graph_obj.vertices[partner].partner_query(vertex.i) and\
                ...
                if mesh_1.num_corners == 4 and mesh_2.num_corners == 3:
...
def process_type_2(graph_obj):
    ...
    type_2, classes = find_type_2(graph_obj)
    print('Found types!')
    changes = 0
    ...
    for vertex in graph_obj.vertices:
        for partner in vertex.partners():
            ...
            if not graph_obj.vertices[partner].partner_query(vertex.i) and\
                ...
                if mesh_1.num_corners == 3 and mesh_2.num_corners == 4:
...
def process_type_3(graph_obj):
    ...
    type_3, classes = find_type_3(graph_obj)
    print('Found types!')
    changes = 0
