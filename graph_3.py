...
class Vertex:
    ...
    def __init__(self, i, x, y, zeta, r, scale, peak_gamma, avg_gamma):
        ...
        self.im_coor_y = y
        self.im_coor_z = zeta
        self.spatial_coor_x = self.im_coor_x * scale
        self.spatial_coor_y = self.im_coor_y * scale
        ...
        # Species and graph symmetry
        self.species_index = 6
        self.n = 3
        self.in_degree = 0
        self.out_degree = 0
        self.degree = 0
        ...
        self.flag_8 = False
        self.flag_9 = False
        self.species_variant_1 = True
        self.species_variant_2 = False
        self.species_variant_3 = False
        self.species_variant_4 = False
        ...
        # Property analysis
        self.species_probability_vector = [0, 0, 0, 0, 0, 0, 1]
        self.confidence = 0
        self.advanced_species_probability_vector = [0, 0, 0, 0, 0, 0, 0]
    ...
    def report(self):
        ...
        string += '        Symmetry: {}\n'.format(self.n)
        string += '    Analysis:\n'
        if self.species_variant_1:
            string += '        Species variant: 1\n'
        elif self.species_variant_2:
            string += '        Species variant: 2\n'
        elif self.species_variant_3:
            string += '        Species variant: 3\n'
        elif self.species_variant_4:
    ...
    def set_species_index(self, species_index):
        ...
        for vertex in self.vertices:
            if vertex.i == i:
                ...
                for arc in self.arcs:
                    if arc.vertex_a.i == i or arc.vertex_b.i == i:
