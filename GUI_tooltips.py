...
btn_redraw_search_mat = 'Recalculate the search matrix'
...
btn_delete = 'Delete the selected column.'
...
btn_new = 'Will place a new column in the middle of the image and active move mode. Place the column at the desired\n' \
          'location and hit \'accept\' inthe \'selected column\' control group.'
